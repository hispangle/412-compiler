            ...
            if(PR == 65){
                if(maxlive > k){ //spillable getPR
                    ...
                    if(use1->NU == 0){
                        ...
                        uint32_t PR_spill = maxPR; //pick PR to spill (PR with max PRtoNU) //will be more complex in the future
